...
$.widget("ech.multiselect", {
			...
			headerLinkContainer = (this.headerLinkContainer = $('<ul />'))
				...
				.html(function(){
					if( o.header === true ){
						...
						//return '<li><label for="ui-multiselect-all"><input type="checkbox" name="ui-multiselect-all" id="ui-multiselect-all" class="ui-multiselect-all" />' + o.checkAllText + '</label></li>';
	...
	_bindEvents: function(){
		...
		// header links
		this.header
			.delegate('a, input[type="checkbox"]', 'click.multiselect', function( e ){
				// close link
	...
	_toggleState: function( prop, flag ){
		console.log('toggleState:', prop, flag)
		return function(){
			if( !this.disabled ) {
